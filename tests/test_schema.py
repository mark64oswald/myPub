...
EXPECTED_COLUMNS = {
    ...
    "chapter": {"chapter_id", "book_id", "chapter_num", "parent_chapter_id",
                "title", "href", "content", "token_count", "embedding",
                "indexed_at"},
    "concept": {"concept_id", "name", "concept_type", "description", "domain",
                "embedding", "pending_review", "query_count", "last_queried_at",
    ...
    "doc_snapshot": {"snapshot_id", "doc_source_id", "source_type", "url",
                     "retrieved_at", "content_hash", "content", "embedding"},
...
EMBEDDING_COLUMNS = [
    ("chapter", "embedding"),
    ("concept", "embedding"),
    ("doc_snapshot", "embedding"),
    ("doc_section", "embedding"),
]
