...
This will take a while for ~570 books. That's fine.
```
...
```text
Run the entity extractor against the full corpus (~570 books) using sub-agents.
...
- At session end, record progress: "completed through book N of ~570"
